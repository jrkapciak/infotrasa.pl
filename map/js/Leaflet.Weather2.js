L.Control.Weather = L.Control.extend({
  options: {
    ...
    template: '<div class="weatherIcon"><img src=":iconurl"></div><div>Temp: :temperature°C</div><div>Wiatr: :winddirection :windspeed m/s</div><div> :pressure hPa </div>',
  ...
  refresh: function(callback) {
    var _this = this,
      ...
      url = "https://api.openweathermap.org/data/2.5/weather?lat=:lat&lon=:lng&lang=pl&units=metric&APPID=15212a2c9c3641fa8627b5c66a17f14e";
  ...
  _updateWidget: function(weather) {
    ...
    tpl = tpl.replace(":pressure", weather.main.pressure);
