...
module.exports={
    ...
    "v5": {
        "constants": {
            ...
            "lanes": {
                "xo": "Trzymaj się prawego pasa",
                "ox": "Trzymaj się lewego pasa",
                "xox": "Trzymaj się środka",
                "oxo": "Trzymaj się lewego lub prawego pasa"
            }
        },
        "modes": {
            "ferry": {
                "default": "Wjedź na prom",
                "name": "Wjedź na prom {way_name}",
                "destination": "Wjedź na prom w kierunku{destination}" 
            }
        },
        "arrive": {
            "default": {
                "default": "Dotarłeś do swojego {nth} celu podróży"
            },
            "left": {
                "default": "Po lewej stronie znajduje się Twój {nth} cel podróży"
            },
            "right": {
                "default": "Po prawej stronie znajduje się Twój {nth} cel podróży"
            },
            "sharp left": {
                "default": "Po lewej stronie znajduje się Twój {nth} cel podróży"
            },
            ...
            "slight left": {
                "default": "Po lewej stronie stronie znajduje się Twój {nth} cel podróży"
            },
            "straight": {
                "default": "Na wprost znajduje się Twój {nth} cel podróży"
            }
        },
        "Kontynuuj": {
            "default": {
                ...
                "destination": "Kontynuuj {modifier} w kierunku celu {destination}"
            },
            "slight left": {
        ...
        "depart": {
            "default": {
                "default": "Jedź {direction}",
                "name": "Jedź {direction} na {way_name}"
            }
        },
        "end of road": {
            "default": {
            ...
            "straight": {
                "default": "Jedź tą trasą",
                "name": "Kontynuuj jazdę prosto na {way_name}",
                "destination": "Kontynuuj jazdę prosto w kierunku {destination}"
            },
            "uturn": {
                "default": "Na końcu drogi skręć w lewo",
                "name": "Na końcu drogi zawróć na {way_name} ",
                "destination": "Na końcu drogi zawróć w kierunku {destination} "
            }
        },
        "fork": {
            "default": {
                "default": "Skręć {modifier} na rozwidleniu",
                "name": "Skręć {modifier} na rozwidleniu na{way_name}",
                "destination": "Skręć {modifier} na rozwidleniu w kierunku {destination}"
            },
            "slight left": {
                "default": "Skręć w lewo na rozwidleniu",
                "name": "Skręć w lewo na rozwidleniu na {way_name}",
                "destination": "Skręć w lewo na rozwidleniu w kierunku{destination}"
            },
            "slight right": {
                "default": "Skręć w prawo na rozwidleniu",
                "name": "Skręć w prawo na rozwidleniu na {way_name}",
                "destination": "Skręć w prawo na rozwidleniu na {destination}"
            },
            "sharp left": {
                "default": "Skręć ostro w lewo na rozwidleniu ",
                "name": "Skręć ostro w lewo na rozwidleniu na{way_name}",
                "destination": "Skręć ostro w lewo na rozwidleniu w kierunku {destination}"
            },
            "sharp right": {
                "default": "Skręć ostro w prawo na rozwidleniu",
                "name": "Skręć ostro w prawo na rozwidleniu na {way_name}",
                "destination": "Skręć ostro w prawo na rozwidleniu w kieurnku {destination}"
            },
            "uturn": {
                "default": "Zawróć",
                "name": "Zawróć na {way_name}",
        ...
        "merge": {
            "default": {
                "default": "Zmień pas {modifier}",
                "name": "Zmień pas {modifier} na {way_name}",
                "destination": "Zmień pas {modifier} w kierunku {destination}"
            },
            "slight left": {
                "default": "Zmień pas na lewy",
                "name": "Zmień pas na lewy na {way_name}",
                "destination": "Zmień pas na lewy w kierunku {destination}"
            },
            "slight right": {
                "default": "Zmień pas na prawy",
                "name": "Zmień pas na prawy na{way_name}",
                "destination": "Zmień pas na prawy w kierunku {destination}"
            },
            "sharp left": {
                "default": "Zmień pas na lewy",
                "name": "Zmień pas na lewy na {way_name}",
        ...
        "new name": {
            ...
            "sharp left": {
                ...
                "name": "Skręć ostro w lewo na {way_name}",
        ...
        "off ramp": {
            "default": {
                "default": "Skręć w zjazd",
                "name": "Skręć w zjazd na {way_name}",
                "destination": "Skręć w zjazd w kierunku {destination}"
            },
            "left": {
                "default": "Skręć w lewy zjazd",
                "name": "Skręć w lewy zjazd na {way_name}",
                "destination": "Skręć w lewy zjazd w kierunku {destination}"
            },
            "right": {
                "default": "Skręć w prawy zjazd",
                "name": "Skręć w prawy zjazd na {way_name}",
                "destination": "Skręć w prawy zjazd w kierunku {destination}"
            },
            "sharp left": {
                "default": "Skręć w lewy zjazd",
                "name": "Skręć w lewy zjazd na {way_name}",
        ...
        "on ramp": {
                    "default": {
                "default": "Skręć w wjazd",
                "name": "Skręć w wjazd na {way_name}",
                "destination": "Skręć w wjazd w kierunku {destination}"
            },
            "left": {
                "default": "Skręć w lewo na wjazd",
                "name": "Skręć w lewo na wjazd na {way_name}",
                "destination": "Skręć w lewo na wjazd w kierunku {destination}"
            },
            "right": {
                "default": "Skręć w prawo na wjazd",
                "name": "Skręć w prawo na wjazd na {way_name}",
                "destination": "Skręć w prawo na wjazd w kierunku {destination}"
            },
            "sharp left": {
               "default": "Skręć w lewo na wjazd",
                "name": "Skręć w lewo na wjazd na {way_name}",
        ...
        "rotary": {
            "default": {
                "default": {
                    ...
                    "name": "Wjedź na rondo na {way_name}",
                    "destination": "Wjedź na rondo w kierunku {destination}"
                },
                "name": {
                    "default": "Wjedź na {rotary_name}",
                    "name": "Wjedź na {rotary_name} i zjedź {way_name}",
                    "destination": "Wjedź na{rotary_name} i zjedź w kierunku {destination}"
                },
                "exit": {
                    "default": "Wjdedź na rondo i zjedź {exit_number} zjazdem",
                    "name": "Wjedź na rondo i zjedź {exit_number} zjazdem na {way_name}",
                    "destination": "Wjedź na rondo i zjedź {exit_number} zjazdem w kierunku {destination}"
                },
                "name_exit": {
                    "default": "Wjedź na {rotary_name} i zjedź {exit_number} zjazdem",
                    "name": "Wjedź na {rotary_name} i zjedź {exit_number}  zjazdem na {way_name}",
                    "destination": "Wjedź na {rotary_name} i zjedź {exit_number} zjazdem w kierunku {destination}"
                }
            }
        },
        "roundabout": {
            "default": {
                "exit": {
                    "default": "Wjedź na rondo i zjedź {exit_number} zjazdem",
                    "name": "Wjedź na rondo i zjedź {exit_number} zjazdem na {way_name}",
                    "destination": "Wjedź na rondo i zjedź {exit_number} zjazdem w kierunku {destination}"
                },
                "default": {
                    "default": "Wjedź na rondo",
                    "name": "Wjedź na rondo i zjedź na {way_name}",
                    "destination": "Wjedź na rondo i zjedź w kierunku {destination}"
                }
            }
        },
        "roundabout turn": {
            "default": {
                "default": "Na rondzie skręć w {modifier}",
                "name": "Na rondzie skręć w {modifier} na {way_name}",
                "destination": "Na rondzie skręć w {modifier} w kierunku {destination}"
            },
            "left": {
                "default": "Na rondzie skręć w lewo",
                "name": "Na rondzie skręć w lewo na {way_name}",
            ...
            "straight": {
                "default": "Na rondzie prosto",
                "name": "Na rondzie prosto na {way_name}",
                "destination": "Na rondzie prosto w kierunku {destination}"
            }
        },
        "turn": {
            "default": {
        ...
        "use lane": {
            "no_lanes": {
                "default": "Kontynuuj jazdę prosto"
            },
            "default": {
                "default": "{lane_instruction}"
            }
...
(function() {
	...
	module.exports = L.Control.extend({
		...
		options: {
			...
			summaryTemplate: "<p align= 'justify'><h2>Odległość:  {distance} </br> czas podróży </b>: {time}</p><h2>",
			timeTemplate: '{time}',
			containerClassName: '',
...
(function() {
	...
	module.exports = L.extend(Localization, {
		'en': {
			...
			ui: {
				startPlaceholder: 'Początek trasy',
				viaPlaceholder: 'przez {viaNumber}',
				endPlaceholder: 'Cel podróży'
			},
			units: {
				meters: 'm',
				kilometers: 'km',
