L.Wikipedia = L.FeatureGroup.extend({
	options: { // AND {language}
		urlTemplate: 'https://dbpedia.org/sparql/?default-graph-uri={defaultGraphUri}&query={query}&format={format}',
		...
		params: {
			format: 'json',
			defaultGraphUri: 'https://dbpedia.org', // ???			
		},
		fields: {
			abstract: [
				"?abstract",
				"?res <https://dbpedia.org/ontology/abstract> ?abstract.",
			...
			lat: [
				"?lat",
				"?res <https://www.w3.org/2003/01/geo/wgs84_pos%23lat> ?lat."
			],
			link: [
				"?link",
			...
			lng: [
				"?lng",
				"?res <https://www.w3.org/2003/01/geo/wgs84_pos%23long> ?lng."
			],
			thumbnail: [
				"?thumbnail",
				"?res <https://dbpedia.org/ontology/thumbnail> ?thumbnail."
			],
			type: [
